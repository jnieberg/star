export default class Word {
	constructor(seed, { syllablesMin = 2, syllablesMax = 5, numberSuffixLength = 0 } = {}) {
		...
		const consS = this._NAME_LETTERS.cons.concat(this._NAME_LETTERS.consSM);
		const consM = this._NAME_LETTERS.cons.concat(this._NAME_LETTERS.consSM, this._NAME_LETTERS.consM);
		const consE = this._NAME_LETTERS.cons.concat(this._NAME_LETTERS.consME);
		const vowlS = this._NAME_LETTERS.vowels;
		const vowlM = this._NAME_LETTERS.vowels;
		const vowlE = this._NAME_LETTERS.vowels.concat(this._NAME_LETTERS.vowelsE);
